...
import { CircleDashed, LoaderIcon, type LucideProps } from "lucide-react";
import { cn } from "@/6.shared/lib/index";
...
const Circle = ({ className, ...props }: SpinnerVariantProps) => (
  <CircleDashed className={cn("animate-spin", className)} {...props} />
);
