...
import type { QuizSubmit } from "@/5.entities/quiz";

interface SubmittedDescriptiveQuizProps {
  quizId: number;
  question: string;
  submittedQuiz: QuizSubmit;
}

export function SubmittedDescriptiveQuiz({
  quizId,
  question,
  submittedQuiz,
}: SubmittedDescriptiveQuizProps) {
