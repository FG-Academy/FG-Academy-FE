  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-white via-slate-50 to-white">
      <div className="mx-auto max-w-7xl px-4 md:px-8 py-8 md:py-12">
        <section id="banner" className="flex flex-col gap-8">
          <div className="relative h-48 md:h-64 lg:h-72 rounded-2xl overflow-hidden shadow ring-1 ring-black/5">
            <Image
              src={IntroBackground}
              alt="인트로 배경"
              fill
            ...
            <div className="absolute inset-0 flex items-end md:items-center">
              <h2 className="px-6 md:px-12 pb-6 md:pb-0 text-2xl md:text-4xl font-semibold tracking-tight text-white">
                아카데미 소개
              </h2>
            </div>
          </div>
          ...
          <div
            id="introText"
            className="mt-2 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start"
          >
            {/* Image Card */}
            ...
            {/* Text Panel */}
            <div className="md:col-span-8 lg:col-span-9 rounded-xl bg-white/70 backdrop-blur p-6 md:p-8 shadow-sm ring-1 ring-slate-200 space-y-6 text-[15px] leading-7 text-slate-700">
              <p>
              ...
              <p>
                특히 코로나로 인해 처참하게 무너진 주일학교는 급속도로 발전하는
                세상 문화를 압도하지 못하고 있고,
              </p>
              <p>
              ...
              <p>
                ...
                끊임없이 노력하고 있으며, 여러분의 성공적인 미래를 지원하기 위해
                최선을 다하고 있습니다.
              </p>
              <p>
                또한 저희는 가치있는 지식과 아이디어를 제공함으로써 바꾸어
                나가야 할 사회적 문제들에 대한 해결책을 제공하고 있습니다. 저희
                아카데미와 함께 사회적 가치를 창출해 나가세요.
              </p>

              <h3 className="pt-2 text-lg md:text-xl font-semibold text-slate-900">
                무엇을 어떻게 가르칠 것인가?
              </h3>
              <p>
                “무엇을 어떻게 가르칠까?” 이 질문은 모든 주일학교 교사들이 품고
                있는 숙제와 같은 질문입니다.
                <br /> 좀 더 효과적인 교육을 위해 책도 읽고 이것저것 프로그램
                강의도 들어보지만 늘 미지한 느낌을 벗어날 수 없습니다. 왜냐하면
                교사가 무엇을 가르칠지 제대로 모르고 있기 때문입니다.
              </p>
              <p>
              ...
              <p>
                ...
                우리의 자녀들과 아이들이 바르게 세상을 헤쳐 나갈 수 있는 지혜와
                능력을 키워줄 것입니다.
              </p>
              <p>
                한국교회와 주일학교가 다시 회복하고 부흥 할 수 있는 방법은 오직
                성경으로 돌아가는 길밖 에 없습니다. 그런 역할을 꽃동산
                아카데미가 훌륭히 수행할 것입니다. 그래서 교사들과 주일학교
                아이들이 말씀으로 바로 서 있을 때 한국 주일학교 역사에는 다시
                한번 주의 말씀이 흥왕하여 세력을 더하는 짜릿한 부흥의 참 기쁨을
                누릴 것입니다.
              </p>
            </div>
          </div>
